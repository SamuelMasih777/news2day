...
export const BanCard = () => {
  return (
    <Fragment>
      <div
        class="w-full h-64 md:mx-4 rounded-md overflow-hidden bg-cover bg-center md:w-1/2 transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-105 hover:shadow-xl"
        style={{
          backgroundImage:
      ...
      >
        <div class="bg-gray-900 bg-opacity-50 flex items-center h-full">
          <div class="px-10 max-w-xl">
            <h2 class="text-2xl text-white font-semibold">Lorem</h2>
      ...
      <div
        class="w-full h-64 mt-8 md:mx-4 rounded-md overflow-hidden bg-cover bg-center md:mt-0 md:w-1/2 transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-105 hover:shadow-xl"
        style={{
          backgroundImage:
