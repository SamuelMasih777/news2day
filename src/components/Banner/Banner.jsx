export const Banner = () => {
  return (
    <div
      class="h-64 rounded-md overflow-hidden bg-cover bg-center transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-105 hover:shadow-xl"
      style={{
        backgroundImage:
    ...
    >
      <div class="bg-gray-900 bg-opacity-50 flex items-center h-full">
        <div class="px-10 max-w-xl">
          <h2 class="text-2xl text-white font-semibold">Sport News</h2>
